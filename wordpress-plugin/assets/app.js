...
class CEFRReadingTest {
    ...
    async initializeApp() {
        try {
            ...
            // Check API health
            const isAPIOnline = await this.apiClient.checkHealth();
            if (!isAPIOnline) {
    ...
    setupEventListeners() {
        ...
        document.getElementById('retryBtn')?.addEventListener('click', () => this.retryCurrentSentence());
        document.getElementById('nextBtn')?.addEventListener('click', () => this.nextSentence());
        document.getElementById('playAudioBtn')?.addEventListener('click', () => this.playRecordedAudio());
    ...
    renderTestArea() {
        ...
        const html = `
            ...
            <div class="controls">
                <button class="btn" id="startBtn" aria-describedby="startBtnDesc">
                    <span>🎤</span> Start Recording
                </button>
                <button class="btn btn-error" id="stopBtn" disabled aria-describedby="stopBtnDesc">
            ...
            <div class="audio-playback" id="audioPlayback">
                <div class="audio-controls">
                    <button class="btn btn-secondary" id="playAudioBtn">
    ...
    async startRecording() {
        ...
        try {
            ...
            this.showNotification(error.message || 'Failed to start recording', 'error');
